...
public class TargetSearchTest3Speakers implements SauceOnDemandSessionIdProvider {
	 ...
	 * @param browser
	 */
	public TargetSearchTest3Speakers(String os, String version, String browser) {
		super();
		this.os = os;
